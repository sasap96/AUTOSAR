 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: NvM_Cfg.c
 *   Generation Time: 2016-04-26 17:59:11
...
VAR(uint8, NVM_PRIVATE_DATA) NvM_InternalBuffer_au8[22UL];
#endif
...
struct PermanentRamBlockLengthChecks {
  ...
  NvM_LengthCheck Block_DemStatusDataBlock : SizeOfRamBlockDoesNotMatchConfiguredLength(Dem_Cfg_StatusData, 0, 20U);
  NvM_LengthCheck Block_DemPrimaryDataBlock0 : SizeOfRamBlockDoesNotMatchConfiguredLength(Dem_PrimaryEntry_0, 0, 8U);
  NvM_LengthCheck Block_DemPrimaryDataBlock1 : SizeOfRamBlockDoesNotMatchConfiguredLength(Dem_PrimaryEntry_1, 0, 8U);
  NvM_LengthCheck Block_DemPrimaryDataBlock2 : SizeOfRamBlockDoesNotMatchConfiguredLength(Dem_PrimaryEntry_2, 0, 8U);
  NvM_LengthCheck Block_DemPrimaryDataBlock3 : SizeOfRamBlockDoesNotMatchConfiguredLength(Dem_PrimaryEntry_3, 0, 8U);
  NvM_LengthCheck Block_DemPrimaryDataBlock4 : SizeOfRamBlockDoesNotMatchConfiguredLength(Dem_PrimaryEntry_4, 0, 8U);
  NvM_LengthCheck Block_DemPrimaryDataBlock5 : SizeOfRamBlockDoesNotMatchConfiguredLength(Dem_PrimaryEntry_5, 0, 8U);
  NvM_LengthCheck Block_DemPrimaryDataBlock6 : SizeOfRamBlockDoesNotMatchConfiguredLength(Dem_PrimaryEntry_6, 0, 8U);
  NvM_LengthCheck Block_DemPrimaryDataBlock7 : SizeOfRamBlockDoesNotMatchConfiguredLength(Dem_PrimaryEntry_7, 0, 8U);
};
...
struct PermRomBlockLengthCheck {
  NvM_LengthCheck Block_DemPrimaryDataBlock0 : SizeOfRomBlockDoesNotMatchConfiguredLength(Dem_MemoryEntryInit, 8U);
  NvM_LengthCheck Block_DemPrimaryDataBlock1 : SizeOfRomBlockDoesNotMatchConfiguredLength(Dem_MemoryEntryInit, 8U);
  NvM_LengthCheck Block_DemPrimaryDataBlock2 : SizeOfRomBlockDoesNotMatchConfiguredLength(Dem_MemoryEntryInit, 8U);
  NvM_LengthCheck Block_DemPrimaryDataBlock3 : SizeOfRomBlockDoesNotMatchConfiguredLength(Dem_MemoryEntryInit, 8U);
  NvM_LengthCheck Block_DemPrimaryDataBlock4 : SizeOfRomBlockDoesNotMatchConfiguredLength(Dem_MemoryEntryInit, 8U);
  NvM_LengthCheck Block_DemPrimaryDataBlock5 : SizeOfRomBlockDoesNotMatchConfiguredLength(Dem_MemoryEntryInit, 8U);
  NvM_LengthCheck Block_DemPrimaryDataBlock6 : SizeOfRomBlockDoesNotMatchConfiguredLength(Dem_MemoryEntryInit, 8U);
  NvM_LengthCheck Block_DemPrimaryDataBlock7 : SizeOfRomBlockDoesNotMatchConfiguredLength(Dem_MemoryEntryInit, 8U);
};
