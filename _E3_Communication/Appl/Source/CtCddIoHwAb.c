 ...
 *  Generated at:  Wed Apr 27 09:42:59 2016
 *
...
#if 0
/***  Start of saved code (symbol: documentation area:RCtCddIoHwAb_PpLocalClamp15_WriteChannel_doc)  ********/
...
#if 0
/***  Start of saved code (symbol: documentation area:RCtCddIoHwAb_PpDisplayState_ReadChannel_doc)  *********/
...
#if 0
/***  Start of saved code (symbol: documentation area:RCtCddIoHwAb_PpLocalClamp15_ReadChannel_doc)  *********/
...
#if 0
/***  Start of saved code (symbol: runnable implementation:RCtCddIoHwAb_PpLocalClamp15_WriteChannel)  *******/
...
#if 0
/***  Start of saved code (symbol: runnable implementation:RCtCddIoHwAb_PpDisplayState_ReadChannel)  ********/
...
#if 0
/***  Start of saved code (symbol: runnable implementation:RCtCddIoHwAb_PpLocalClamp15_ReadChannel)  ********/
...
#if 0
/***  Start of saved code (symbol: documentation area:RCtCddIoHwAb_PpDisplayState_WriteChannel_doc)  ********/
...
#if 0
/***  Start of saved code (symbol: runnable implementation:RCtCddIoHwAb_PpDisplayState_WriteChannel)  *******/
