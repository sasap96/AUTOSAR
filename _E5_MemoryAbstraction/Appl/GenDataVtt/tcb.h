...
#define Rte_Ev_Run_CpSaDisplay_RCtApDisplayBusStateHandling ((EventMaskType)(0x00000001))/* AUTO */
#define Rte_Ev_Run_CpSaDisplay_RCtApDisplayLightOnOffHandling ((EventMaskType)(0x00000002))/* AUTO */
#define Rte_Ev_Run_CpSaDisplay_RCtApDisplayOdometerValue ((EventMaskType)(0x00000004))/* AUTO */
#define Rte_Ev_Run_CpSaDisplay_RCtApDisplayOdometerWriteRequestPending ((EventMaskType)(0x00000008))/* AUTO */
#define Rte_Ev_Run_CpSaInteriorLightFront_RCtSaInteriorLightSwitchLight ((EventMaskType)(0x00000010))/* AUTO */
#define Rte_Ev_Cyclic_IO_Task_0_200ms ((EventMaskType)(0x00000020))/* AUTO */
#define Rte_Ev_Run_CpApMySwc_RCtApMySwcCode ((EventMaskType)(0x00000001))/* AUTO */
#define Rte_Ev_Run_CpApMySwc_RCtApMySwcComM_ModeChange_FULL_COMM_Entry ((EventMaskType)(0x00000002))/* AUTO */
#define Rte_Ev_Run_CpApMySwc_RCtApMySwcComM_ModeChange_FULL_COMM_Exit ((EventMaskType)(0x00000004))/* AUTO */
...
#define Rte_Al_TE_CpApMySwc_RCtApMySwcCode ((AlarmType)2)
#define Rte_Al_TE_IO_Task_0_200ms ((AlarmType)3)
#define Rte_Al_TE_Fee_Fee_MainFunction ((AlarmType)4)
...
/* END OF C:\CanCollege\AUTOSAR4\_E5_MemoryAbstraction\Appl\GenDataVtt\tcb.h */
