...
# define Rte_TypeDef_BswM_MdgBswMRequestShutdown
typedef uint8 BswM_MdgBswMRequestShutdown;
...
extern CONST(EventMaskType, RTE_CONST) Rte_ModeExitEventMask_ComM_UM_USR_CHNL_CAN00_currentMode[3];
extern CONST(EventMaskType, RTE_CONST) Rte_ModeEntryEventMask_ComM_UM_USR_CHNL_CAN00_currentMode[3];
...
} Rte_ModeInfoType_ComM_UM_USR_CHNL_CAN00_currentMode;
