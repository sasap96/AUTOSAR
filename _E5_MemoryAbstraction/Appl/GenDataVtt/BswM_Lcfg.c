 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: BswM_Lcfg.c
 *   Generation Time: 2016-07-20 13:18:16
...
BSWM_LOCAL VAR(Rte_ModeType_MdgBswMRequestShutdown, BSWM_VAR_NOINIT) BswM_Mode_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMRequestShutdown_BswM_MDGP_MdgBswMRequestShutdown;
...
/*lint -restore */
CONST(BswM_ActionListsType, BSWM_CONST) BswM_ActionLists[20] = {
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
CONST(BswM_DeferredRulesType, BSWM_CONST) BswM_DeferredRules[8] = {
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
CONST(BswM_RulesType, BSWM_CONST) BswM_Rules[15] = {
    /* Index    Id   FctPtr                                   Referable Keys */
  { /*     0 */  0U, BswM_Rule_BswMRule_EcuShutdown    },  /* [R_BswMRule_EcuShutdown, MRP_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMRequestShutdown] */
  { /*     1 */  2U, BswM_Rule_CC_CAN00_f26020e5_RX_DM },  /* [R_CC_CAN00_f26020e5_RX_DM, MRP_CC_CanSMIndication_CAN00_f26020e5] */
  { /*     2 */  1U, BswM_Rule_CC_CAN00_f26020e5_RX    },  /* [R_CC_CAN00_f26020e5_RX, MRP_CC_CanSMIndication_CAN00_f26020e5] */
  { /*     3 */  3U, BswM_Rule_CC_CAN00_f26020e5_TX    },  /* [R_CC_CAN00_f26020e5_TX, MRP_CC_CanSMIndication_CAN00_f26020e5] */
  { /*     4 */  8U, BswM_Rule_ESH_PrepToWait          },  /* [R_ESH_PrepToWait, MRP_ESH_State, MRP_ESH_ModeNotification] */
  { /*     5 */ 11U, BswM_Rule_ESH_WaitToShutdown      },  /* [R_ESH_WaitToShutdown, MRP_ESH_State, MRP_ESH_NvMIndication, MRP_ESH_NvM_WriteAllTimer, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests] */
  { /*     6 */ 12U, BswM_Rule_ESH_WaitToWakeup        },  /* [R_ESH_WaitToWakeup, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests] */
  { /*     7 */  9U, BswM_Rule_ESH_RunToPostRun        },  /* [R_ESH_RunToPostRun, MRP_ESH_State, MRP_ESH_ComMIndication_CAN00_f26020e5, MRP_ESH_SelfRunRequestTimer, MRP_ESH_ModeNotification] */
  { /*     8 */ 14U, BswM_Rule_ESH_WakeupToRun         },  /* [R_ESH_WakeupToRun, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_NvMIndication, MRP_ESH_NvM_CancelWriteAllTimer, MRP_ESH_ModeNotification] */
  { /*     9 */ 13U, BswM_Rule_ESH_WakeupToPrep        },  /* [R_ESH_WakeupToPrep, MRP_ESH_State, MRP_ESH_NvMIndication, MRP_ESH_NvM_CancelWriteAllTimer, MRP_ESH_EcuM_GetPendingWakeupEvents, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_ModeNotification] */
  { /*    10 */  5U, BswM_Rule_ESH_InitToWakeup        },  /* [R_ESH_InitToWakeup, MRP_ESH_State] */
  { /*    11 */  4U, BswM_Rule_ESH_DemInit             },  /* [R_ESH_DemInit] */
  { /*    12 */ 10U, BswM_Rule_ESH_RunToPostRunNested  },  /* [R_ESH_RunToPostRunNested] */
  { /*    13 */  7U, BswM_Rule_ESH_PostRunNested       },  /* [R_ESH_PostRunNested] */
  { /*    14 */  6U, BswM_Rule_ESH_PostRun             }   /* [R_ESH_PostRun, MRP_ESH_State, MRP_ESH_ModeNotification] */
};
#define BSWM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
VAR(BswM_RuleStatesType, BSWM_VAR_NOINIT) BswM_RuleStates[15];
  /* Index        Referable Keys  */
  /*     0 */  /* [R_BswMRule_EcuShutdown, MRP_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMRequestShutdown] */
 ...
 *  - If arbitration leads to a valid action list ID, execute the corresponding action list.
...
FUNC(void, BSWM_CODE) BswM_Init_Gen(void)
{
  ...
  BswM_Mode_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMRequestShutdown_BswM_MDGP_MdgBswMRequestShutdown = RTE_MODE_MdgBswMRequestShutdown_BSWM_REQUESTSHUTDOWN_INACTIVE;
...
{
  uint32 mode;
  mode = Rte_Mode_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMRequestShutdown_BswM_MDGP_MdgBswMRequestShutdown();
  if (mode != RTE_TRANSITION_MdgBswMRequestShutdown)
  {
    BswM_Mode_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMRequestShutdown_BswM_MDGP_MdgBswMRequestShutdown = (Rte_ModeType_MdgBswMRequestShutdown)mode;
  }
...
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_BswMRule_EcuShutdown(void)
{
  ...
  if(BswM_Mode_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMRequestShutdown_BswM_MDGP_MdgBswMRequestShutdown == RTE_MODE_MdgBswMRequestShutdown_BSWM_REQUESTSHUTDOWN_ACTIVE)
  {
