 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  CtApMySwc.c
 *        Config:  C:/CanCollege/AUTOSAR4/_E5_MemoryAbstraction/MyECU.dpa
 *     SW-C Type:  CtApMySwc
 *  Generated at:  Wed Jul 20 13:50:17 2016
 *
 ...
 *********************************************************************************************************************/
  ...
  /* Write the config block once, to have a valid flash image, no pointer needed for config block */
  /* This is just a work around, because config block is only written on shut down, which is not yet applicable for this exercise */
  /* writing the config block also writes the config ID which is used by the NVM to retrieve RES blocks after a SW Update */
  /* If config block is not properly written, the NVM always detects config mismatch and tries to restore RES blocks */
