...
extern VAR(IdtDoorState, RTE_VAR_NOINIT) Rte_CpSaDoorFrontRight_PpDooState_DeDoorState; /* PRQA S 0850 */ /* MD_MSR_19.8 */
 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_CtApMySwc_PpLightStateFront_DeLightState(IdtDoorState data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_Read_CtApMySwc_PpDoorStateFrontRight_DeDoorState(data) (*(data) = Rte_CpSaDoorFrontRight_PpDooState_DeDoorState, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
