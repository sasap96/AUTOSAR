 ...
 *   Generation Time: 2024-10-23 09:37:37
...
# define STATIC static
 ...
 /* Number of configured Channels = 0 --> No VttDio_Channels[] available */ 

 /* Number of configured ChannelGroups = 0 --> No VttDio_Groups[] available */ 
...
**********************************************************************************************************************/
 ...
 /* Number of configured Channels = 0 --> No VttDio_ChannelHandle[] available */ 
 /* Number of configured ChannelGroups = 0 --> No VttDio_GroupHandle[] available */ 
