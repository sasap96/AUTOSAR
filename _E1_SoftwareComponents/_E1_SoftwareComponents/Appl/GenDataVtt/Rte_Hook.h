 ...
 *  Rte_WriteHook_CtSaDoor_PpDooState_DeDoorState_Return
 *  Rte_WriteHook_CtSaDoor_PpDooState_DeDoorState_Start
 *
 *********************************************************************************************************************/
...
#  undef Rte_ReadHook_CtSaInteriorLight_PpLightState_DeLightState_Return /* PRQA S 0841 */ /* MD_MSR_19.6 */
FUNC(void, RTE_APPL_CODE) Rte_ReadHook_CtSaInteriorLight_PpLightState_DeLightState_Return(P2CONST(struct Rte_CDS_CtSaInteriorLight, AUTOMATIC, RTE_CONST) self, P2VAR(IdtDoorState, AUTOMATIC, RTE_CTSAINTERIORLIGHT_APPL_VAR) data); /* PRQA S 0850, 0777 */ /* MD_MSR_19.8, MD_Rte_0777 */
# else
...
#  undef Rte_ReadHook_CtSaInteriorLight_PpLightState_DeLightState_Start /* PRQA S 0841 */ /* MD_MSR_19.6 */
FUNC(void, RTE_APPL_CODE) Rte_ReadHook_CtSaInteriorLight_PpLightState_DeLightState_Start(P2CONST(struct Rte_CDS_CtSaInteriorLight, AUTOMATIC, RTE_CONST) self, P2VAR(IdtDoorState, AUTOMATIC, RTE_CTSAINTERIORLIGHT_APPL_VAR) data); /* PRQA S 0850, 0777 */ /* MD_MSR_19.8, MD_Rte_0777 */
# else
...
#  undef Rte_WriteHook_CtApMySwc_PpLightStateFront_DeLightState_Return /* PRQA S 0841 */ /* MD_MSR_19.6 */
FUNC(void, RTE_APPL_CODE) Rte_WriteHook_CtApMySwc_PpLightStateFront_DeLightState_Return(IdtDoorState data); /* PRQA S 0850, 0777 */ /* MD_MSR_19.8, MD_Rte_0777 */
# else
...
#  undef Rte_WriteHook_CtApMySwc_PpLightStateFront_DeLightState_Start /* PRQA S 0841 */ /* MD_MSR_19.6 */
FUNC(void, RTE_APPL_CODE) Rte_WriteHook_CtApMySwc_PpLightStateFront_DeLightState_Start(IdtDoorState data); /* PRQA S 0850, 0777 */ /* MD_MSR_19.8, MD_Rte_0777 */
# else
...
# if defined (Rte_WriteHook_CtSaDoor_PpDooState_DeDoorState_Return) && (RTE_VFB_TRACE == 0)
#  undef Rte_WriteHook_CtSaDoor_PpDooState_DeDoorState_Return /* PRQA S 0841 */ /* MD_MSR_19.6 */
# endif
# if defined (Rte_WriteHook_CtSaDoor_PpDooState_DeDoorState_Return)
#  undef Rte_WriteHook_CtSaDoor_PpDooState_DeDoorState_Return /* PRQA S 0841 */ /* MD_MSR_19.6 */
FUNC(void, RTE_APPL_CODE) Rte_WriteHook_CtSaDoor_PpDooState_DeDoorState_Return(P2CONST(struct Rte_CDS_CtSaDoor, AUTOMATIC, RTE_CONST) self, IdtDoorState data); /* PRQA S 0850, 0777 */ /* MD_MSR_19.8, MD_Rte_0777 */
# else
#  define Rte_WriteHook_CtSaDoor_PpDooState_DeDoorState_Return(self, arg1) ((void)(0)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
# endif /* Rte_WriteHook_CtSaDoor_PpDooState_DeDoorState_Return */

# if defined (Rte_WriteHook_CtSaDoor_PpDooState_DeDoorState_Start) && (RTE_VFB_TRACE == 0)
#  undef Rte_WriteHook_CtSaDoor_PpDooState_DeDoorState_Start /* PRQA S 0841 */ /* MD_MSR_19.6 */
# endif
# if defined (Rte_WriteHook_CtSaDoor_PpDooState_DeDoorState_Start)
#  undef Rte_WriteHook_CtSaDoor_PpDooState_DeDoorState_Start /* PRQA S 0841 */ /* MD_MSR_19.6 */
FUNC(void, RTE_APPL_CODE) Rte_WriteHook_CtSaDoor_PpDooState_DeDoorState_Start(P2CONST(struct Rte_CDS_CtSaDoor, AUTOMATIC, RTE_CONST) self, IdtDoorState data); /* PRQA S 0850, 0777 */ /* MD_MSR_19.8, MD_Rte_0777 */
# else
#  define Rte_WriteHook_CtSaDoor_PpDooState_DeDoorState_Start(self, arg1) ((void)(0)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
# endif /* Rte_WriteHook_CtSaDoor_PpDooState_DeDoorState_Start */
