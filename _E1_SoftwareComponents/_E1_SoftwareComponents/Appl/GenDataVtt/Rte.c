...
VAR(IdtDoorState, RTE_VAR_NOINIT) Rte_CpApMySwc_PpLightStateFront_DeLightState; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
VAR(IdtDoorState, RTE_VAR_NOINIT) Rte_CpSaDoorFrontLeft_PpDooState_DeDoorState; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
VAR(IdtDoorState, RTE_VAR_NOINIT) Rte_CpSaDoorFrontRight_PpDooState_DeDoorState; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
 ...
 * API Prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_WriteInst1_CtSaDoor_PpDooState_DeDoorState(IdtDoorState data); /* PRQA S 0850, 3447 */ /* MD_MSR_19.8, MD_Rte_3447 */
FUNC(Std_ReturnType, RTE_CODE) Rte_WriteInst2_CtSaDoor_PpDooState_DeDoorState(IdtDoorState data); /* PRQA S 0850, 3447 */ /* MD_MSR_19.8, MD_Rte_3447 */
...
CONST(struct Rte_CDS_CtSaDoor, RTE_CONST) Rte_Instance_CpSaDoorFrontLeft =
{
  /* Port API section */
  {
    Rte_WriteInst1_CtSaDoor_PpDooState_DeDoorState,
  },
...
CONST(struct Rte_CDS_CtSaDoor, RTE_CONST) Rte_Instance_CpSaDoorFrontRight =
{
  /* Port API section */
  {
    Rte_WriteInst2_CtSaDoor_PpDooState_DeDoorState,
  },
  /* Vendor specific section */
};
/* PRQA L:L1 */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Start(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  Rte_CpSaDoorFrontLeft_PpDooState_DeDoorState = 0U;
  Rte_CpSaDoorFrontRight_PpDooState_DeDoorState = 0U;
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_CtApMySwc_PpLightStateFront_DeLightState(IdtDoorState data) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
...
FUNC(Std_ReturnType, RTE_CODE) Rte_WriteInst1_CtSaDoor_PpDooState_DeDoorState(IdtDoorState data) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
  Std_ReturnType ret = RTE_E_OK;

  Rte_CpSaDoorFrontLeft_PpDooState_DeDoorState = *(&data);
  /* scheduled trigger for runnables: RCtApMySwcCode */
  (void)ActivateTask(My_Task); /* PRQA S 3417 */ /* MD_Rte_Os */
  return ret;
} /* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */

FUNC(Std_ReturnType, RTE_CODE) Rte_WriteInst2_CtSaDoor_PpDooState_DeDoorState(IdtDoorState data) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
  Std_ReturnType ret = RTE_E_OK;

  Rte_CpSaDoorFrontRight_PpDooState_DeDoorState = *(&data);
  /* scheduled trigger for runnables: RCtApMySwcCode */
  (void)ActivateTask(My_Task); /* PRQA S 3417 */ /* MD_Rte_Os */
  return ret;
} /* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
TASK(My_Task) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
  ...
  /* read implicit data */
  *(&Rte_My_Task.Rte_RB.Rte_CtApMySwc_RCtApMySwcCode.Rte_PpDoorStateFrontLeft_DeDoorState.value) = Rte_CpSaDoorFrontLeft_PpDooState_DeDoorState;
