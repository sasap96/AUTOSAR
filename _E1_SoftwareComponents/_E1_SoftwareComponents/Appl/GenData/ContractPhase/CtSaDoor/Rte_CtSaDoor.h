...
# define Rte_InitValue_PpDooState_DeDoorState (0U)
 ...
 *********************************************************************************************************************/
# define Rte_Write_PpDooState_DeDoorState(self, data) ((self)->PpDooState.Write_DeDoorState(data)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
